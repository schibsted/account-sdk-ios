...
class JWTTests: QuickSpec {
    ...
    let jwt
        = "eyJ0eXAiOiJKV1MiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwczovL2lkZW50aXR5L"
        + "XByZS5zY2hpYnN0ZWQuY29tLyIsImNsYXNzIjoidG9rZW4uT0F1dGhVc2VyQWNjZXNzVG9"
        + "rZW4iLCJleHAiOjE1MzM3MjEwODQsImlhdCI6MTUzMzcxNzQ4NCwic3ViIjoiMTAxMDEwM"
        + "TAtMDAwMC1mZmZmLTAwMDAtMTAxMDEwMTAxMDEwIiwiYXVkIjoiaHR0cHM6Ly9wcmUuc2R"
        + "rLWV4YW1wbGUuY29tIiwic2NvcGUiOiJyYW5kb21fc2NvcGUgb3BlbmlkIiwidXNlcl9pZ"
        + "CI6IjEwMDAwIiwiYXpwIjoiOTEwMTkxMDE5MTAxOTEwMTkxMDE5MTAxIiwiY2xpZW50X2l"
        + "kIjoiOTEwMTkxMDE5MTAxOTEwMTkxMDE5MTAxIn0.pfm2hrBYcTEqvyMpSoqc86RgdN5i7"
        + "2jIRy8fnCPKR-I"
